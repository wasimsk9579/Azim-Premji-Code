...
export default class Apfs_DisbursalAmountPayable extends NavigationMixin(LightningElement) {
    @track recordTypeId;
   ...
   @track columns = [
    ...
    exportContactData(){
        ...
        this.records.forEach(record => {
            doc += '<tr>';
            doc += '<th>'+record['Application__r.Name']+'</th>'; 
            doc += '<th>'+record['Contact__r.Name']+'</th>'; 
            doc += '<th>'+record['Total_Scholarship_Amount__c']+'</th>';
            doc += '<th>'+record['Offer_Name']+'</th>'; 
            doc += '</tr>';
        });
        doc += '</table>';
