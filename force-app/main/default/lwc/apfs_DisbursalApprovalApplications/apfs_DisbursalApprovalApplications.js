...
import fetchRecords from '@salesforce/apex/APFS_PrioritizeApplications.fetchDisbursalApprovalRecords';
...
export default class Apfs_DisbursalApprovalApplications extends LightningElement {
    @track recordTypeId;
    @track contactRecordTypeId;
    internalPicklistValues;
    @track readOnlyInternalValue = 'Offer Verification Cleared';
    ...
    wiredInternalPicklistValues({ error, data }) {
        if (data) {
            ...
            const desiredValues = ['Ready For Disbursal'];
